...
1. run to prepare application containers `docker pull zenko/cloudserver:8.2.7 && docker pull arangodb:3.7.11 && docker pull hazelcast/hazelcast:4.1.5 && docker pull jaegertracing/all-in-one:1.25.0 && docker pull otel/opentelemetry-collector:0.33.0`
